...
class _$LoadingImpl implements Loading {
  const _$LoadingImpl({required this.productId});
...
abstract class Loading implements DeleteProductState {
  const factory Loading({required final String productId}) = _$LoadingImpl;
...
abstract class Success implements DeleteProductState {
...
class __$$FailureImplCopyWithImpl<$Res>
    extends _$DeleteProductStateCopyWithImpl<$Res, _$FailureImpl>
...
class _$FailureImpl implements Failure {
  ...
  @override
  String toString() {
    return 'DeleteProductState.failure(error: $error)';
  }
...
abstract class Failure implements DeleteProductState {
